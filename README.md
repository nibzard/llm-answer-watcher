...
- **🤖 Multi-Provider Support**: OpenAI, Anthropic, Mistral, Google, DeepSeek, XAI (100+ models)
...
```bash
# Example pre-run output:
Estimated cost: $0.0360 for 6 queries (includes 20% buffer)
✓ Budget check passed
Starting run...
```
